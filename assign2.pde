...
void draw() {
  ...
  switch (gameState){
    ...
    //boundary detection
    if (xFighter > 640-fighter.width/2 ) { xFighter = fighter.width/2 ; }
    if (xFighter < fighter.width/2 ) { xFighter = 640-fighter.width/2 ; }
    if (yFighter > 480-fighter.height/2 ) { yFighter = fighter.height/2 ; }
    if (yFighter < fighter.height/2 ) { yFighter = 480-fighter.height/2 ; }
